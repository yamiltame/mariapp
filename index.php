...
<?php session_start(); if(isset($_SESSION['loggedin'])){ header('Location: views/inicio.php'); exit; } ?>
  <body>
				...
				<div class="col-lg-12">		
					<div class="card">
						<div class="loginBox">
							...
							<p><a href="#showForm" data-toggle="collapse" aria-expanded="false" aria-controls="collapse">Olvidaste contraseña?</a></p>	
							<div class="collapse" id="showForm">
								<div class='well'>
									<form action="controllers/password-recovery.php" method="post">
										<div class="form-group">										
